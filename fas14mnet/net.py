...
class Fas14MNet(nn.Module):
	...
	def __init__(self, num_classes, layers=[1, 1, 1]):
		...
		self.block1 = self.create_core_block(64, layers[0], prune=False)
		self.maxpool1 = nn.MaxPool2d(kernel_size=2)
		self.block2 = self.create_core_block(256, layers[1], stride=2, prune=True, hidden=1)
		self.maxpool2 = nn.MaxPool2d(kernel_size=2)
		self.block3 = self.create_core_block(512, layers[2], stride=2, prune=True, hidden=2)
